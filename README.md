...
| :--- | :--- | :--- |
| **`./.antigravity/observations/`** | **L4: Project Local** | **[任意]** プロジェクト固有の知見やルール。チームで規律を共有したい場合は Git に含め、個人用とする場合は `.gitignore` に追加してください。 |
...
- **`.antigravity/skills/`** : 開発中のメタ・スキル
- **`.antigravity/observations/`** : プロジェクト固有の知見 (L4: Project Local)
