...
**公式ガイダンス：** Anthropic公式のスキル作成ベストプラクティスについては、[anthropic-best-practices.md](./anthropic-best-practices.md)を参照してください。このドキュメントは、このスキルでのTDDに焦点を当てたアプローチを補完する、追加のパターンとガイドラインを提供します。
